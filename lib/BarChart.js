...
var DataSet = (0, _createReactClass.default)({
  ...
  render: function render() {
    var _this$props = this.props,
        ...
        showBarTotal = _this$props.showBarTotal,
        barTotalFormat = _this$props.barTotalFormat,
        barTotalOffset = _this$props.barTotalOffset;
    var bars;
    var barTotalLabels = [];
    ...
    if (groupedBars) {
      ...
      if (showBarTotal) {
        ...
        data.forEach(function (stack) {
          return values(stack).forEach(function (e) {
            var x = e.x;
            ...
            var yVal = y(e) < 0 ? yScale(y0(e)) : yScale(y0(e) + y(e)); // Set y value (Last value)

            barTotalData[x].y = yVal; // Add total

            barTotalData[x].total += e.y;
          });
        }); // Iterate over data

        for (var _x in barTotalData) {
          barTotalLabels.push(_react.default.createElement("text", {
          ...
          }, barTotalFormat(barTotalData[_x].total)));
        }
      }
    }

    return _react.default.createElement("g", null, bars.concat(barTotalLabels));
  }
});
var BarChart = (0, _createReactClass.default)({
  ...
  render: function render() {
    var _this$props2 = this.props,
        ...
        showBarTotal = _this$props2.showBarTotal,
        barTotalFormat = _this$props2.barTotalFormat,
        barTotalOffset = _this$props2.barTotalOffset;
    var data = this._data;
